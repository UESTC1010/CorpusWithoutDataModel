...
//        long start = System.currentTimeMillis();
        ...
        ////////////////生成词网////////////////////
        //System.out.println("词图："+GenerateWordNet(wordNetAll));
...
//        start = System.currentTimeMillis();
        ...
        System.out.println("verterList:"+vertexList);
//        System.out.println("最短路：" + (System.currentTimeMillis() - start));

        if (config.useCustomDictionary)
        {
            combineByCustomDictionary(vertexList);
            System.out.println("useCustomDictionary");
        }
        ...
        //return convert(vertexList, config.offset);//offset
        System.out.println("viterbi1");
